...
class DoctorProfile extends Component {
    ...
    componentDidMount() {
        ...
        axios.get(`http://localhost:3000/api/profile/${id}`, config)
            .then((response) => {
    ...
    actionUploadProfilePic = (e) => {
        ...
        axios.post(`http://localhost:3000/api/uploads/${this.state.user._id}`, formData, config).then((response) => {
    ...
    actionDelete = (event) => {
        ...
        axios.delete(`http://localhost:3000/api/eraseMe`, config)
            .then((response) => {
                console.log(response.data)
                this.setState({
                    isDeleted: true
                            ...
                            <div className='card'>
                                <div className='card-header alert-info'>
                                    ...
                                    <p className='btn btn-sm border-secondary '>
                                        <a href="/medicine-list">Medicines List</a> |
