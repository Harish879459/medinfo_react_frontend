...
class DiseaseList extends Component {
    ...
    componentDidMount() {
        ...
        axios.get('http://localhost:3000/api/findMedicine', this.state.config)
            .then((response) => {
                this.setState({
    ...
    handleDelete = (diseaseId) => {
        ...
        axios.delete(`http://localhost:3000/api/deleteMedicine/${diseaseId}`, config)
            .then((response) => {
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-12">
                                <div className="card">
                                    <div className="card-header alert-info">Medicines</div>
                                                        ...
                                                        <li>
                                                            <a href="/add-medicine"
                                                               ...
                                                               className='text-custom btn border-secondary btn-sm'>
                                                                Medicines <i className='fa fa-plus-circle'></i></a>
                                                            <a style={{float: "right"}}
                                                                ...
                                                                <div className="col-sm-12 custom-disease">
                                                                    <button style={{
                                                                        ...
                                                                        borderRadius: '20px'
                                                                            ...
                                                                            onClick={(event) => {
                                                                                if (window.confirm(`Are you sure want to delete ${disease.name} ?`))
                                                                    ...
                                                                    <Link to={{
                                                                        pathname: `update-medicine/${disease._id}`
                                                                    }}
